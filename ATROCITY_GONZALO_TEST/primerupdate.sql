...
-- DATABASE UPGRADE SCRIPT OF TEST GONZALO FROM PRODUCT NO  TO PRODUCT NO 1
...
-- Generated by Ericsson Service Designer on Mon Mar 13 10:01:41 CLT 2017
...
CREATE TABLE c##test.CWPWORKLISTNOTESARCHIVE(
...
CREATE TABLE c##test.CWPWORKLISTNOTES(
	TASKNOTEID VARCHAR2(16) NOT NULL,
	TASKID VARCHAR2(32),
	NOTES_BLOB NCLOB,
	CREATEDON DATE,
...
INSERT INTO CWPRODUCTPROPERTIES (ID,NVALUE) VALUES('TEST GONZALO',1);
