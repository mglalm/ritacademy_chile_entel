...
-- Generated by Ericsson Service Designer on Fri Mar 03 11:50:31 CLT 2017
...
CREATE TABLE c##train.datosCompra(
	...
	MSISDN VARCHAR2(11),
	PO VARCHAR2(255),
	REQUESTERID NUMBER(10),
	CONSTRAINT PK_datosCompra PRIMARY KEY(CWDOCID) USING INDEX
	(CREATE UNIQUE INDEX PK_datosCompra ON datosCompra(CWDOCID) TABLESPACE &DEFAULT_TABLESPACE_INDEX)
)
