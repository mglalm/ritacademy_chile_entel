...
-- Generated by Ericsson Service Designer on Thu Mar 02 10:58:35 CLT 2017
...
CREATE TABLE C##TRAIN_2.gg_orderData(
	...
	CONSTRAINT PK_gg_orderData PRIMARY KEY(CWDOCID) USING INDEX
	(CREATE UNIQUE INDEX PK_gg_orderData ON gg_orderData(CWDOCID) TABLESPACE &DEFAULT_TABLESPACE_INDEX)
)
