...
CREATE SEQUENCE SEQ_ID_CLIENTE_BSCS MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;

insert into BSCS_CLIENTE_ESTADO values ('1','ACTIVO');
insert into BSCS_CLIENTE_ESTADO values ('2','DESACTIVO');
COMMIT;

insert into BSCS_MSISDN_ESTADO values ('1','DISPONIBLE');
insert into BSCS_MSISDN_ESTADO values ('2','RESERVADO');
insert into BSCS_MSISDN_ESTADO values ('3','ASIGNADO');
COMMIT;
